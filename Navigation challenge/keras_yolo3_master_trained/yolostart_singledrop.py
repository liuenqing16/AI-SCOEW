import sys
import os
sys.path.append("D:\install\DLAM-feedback\keras_yolo3_master_trained\model_data")
from keras_yolo3_master_trained.yolo_singledrop import YOLO
...
class ImageDetector:
    ...
    def detection(self, image):
        ...
        path = 'D:\install\DLAM-feedback\\result/'
...
if __name__ == "__main__":
    img0 = 'D:\\install\\DLAM-feedback\\img\\000153.jpg'
    img = Image.open(img0)
...
# image = image.resize((int(width * factor), int(height * factor)), Image.ANTIALIASING)
