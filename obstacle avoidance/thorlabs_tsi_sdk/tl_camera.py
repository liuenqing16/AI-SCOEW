...
class TLCamera(object):
    ...
    def get_is_operation_mode_supported(self, operation_mode):
        ...
        :param: tap (:ref:`OPERATION_MODE<Ref-OPERATION_MODE>`) - The operation mode to check.
    ...
    def convert_gain_to_decibels(self, gain):
        # type: (int) -> float
        """
        Use this method to convert the gain from the :ref:`gain<Ref-TLCamera-gain>` property into units of Decibels
        (dB).
    ...
    def convert_decibels_to_gain(self, gain_db):
        ...
        :ref:`convert_gain_to_decibels<Ref-TLCamera-convert_decibels_to_gain>` method back into a gain index.
        (dB).
    ...
    def roi(self):
        ...
        To determine the available ROI ranges, use the :ref:`roi_range<Ref-TLCamera-roi_range>`.
    ...
    def polar_phase(self):
        """
        :ref:`POLAR_PHASE<Ref-POLAR_PHASE>`::
        ...
        if a camera supports polarization, check the `camera_sensor_type<Ref-TLCamera-camera_sensor_type>`
    ...
    def frame_rate_control_value_range(self):
        ...
        :ref:`frame_rate_control_value<Ref-TLCamera-frame_rate_control_value>` property.
    ...
    def is_frame_rate_control_enabled(self):
        ...
        :ref:`frame_rate_control_value<Ref-TLCamera-frame_rate_control_value>`.
